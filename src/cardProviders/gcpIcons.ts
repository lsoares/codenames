...
const ICONS: [string, string][] = [
  ...
  ['advanced-agent-modeling', 'Advanced Agent Modeling'],
  ['advanced-solutions-lab', 'Advanced Solutions Lab'],
  ...
  ['automl-translation', 'AutoML Translation'],
  ['automl-video-intelligence', 'AutoML Video Intelligence'],
  ['automl-vision', 'AutoML Vision'],
  ['bare-metal-solutions', 'Bare Metal Solutions'],
  ['batch', 'Batch'],
  ...
  ['dialogflow-insights', 'Dialogflow Insights'],
  ['document-ai', 'Document AI'],
  ['early-access-center', 'Early Access Center'],
  ['error-reporting', 'Error Reporting'],
  ['eventarc', 'Eventarc'],
  ['filestore', 'Filestore'],
  ['financial-services-marketplace', 'Financial Services Marketplace'],
  ['firestore', 'Firestore'],
  ['fleet-engine', 'Fleet Engine'],
  ['free-trial', 'Free Trial'],
  ['game-servers', 'Game Servers'],
  ['gce-systems-management', 'GCE Systems Management'],
  ['genomics', 'Genomics'],
  ['gke-on-prem', 'GKE on Prem'],
  ['google-cloud-marketplace', 'Google Cloud Marketplace'],
  ['google-kubernetes-engine', 'Google Kubernetes Engine'],
  ['google-maps-platform', 'Google Maps Platform'],
  ['healthcare-nlp-api', 'Healthcare NLP API'],
  ['home', 'Home'],
  ...
  ['iot-core', 'IoT Core'],
  ['iot-edge', 'IoT Edge'],
  ['key-access-justifications', 'Key Access Justifications'],
  ...
  ['media-translation-api', 'Media Translation API'],
  ...
  ['os-inventory-management', 'OS Inventory Management'],
  ['os-patch-management', 'OS Patch Management'],
  ...
  ['premium-network-tier', 'Premium Network Tier'],
