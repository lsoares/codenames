...
export const memes: CardProvider = { id: 'memes', label: 'Memes', icon: '😂', description: 'Popular meme templates', credit: { label: 'Imgflip', url: 'https://imgflip.com' }, hidden: true, fetch }
