...
export const tmdb: CardProvider = { id: 'tmdb', label: 'Movies', group: 'culture', difficulty: 'tough', icon: '🎬', description: 'Stills from popular and acclaimed films', credit: { label: 'TMDB', url: 'https://www.themoviedb.org' }, fetch }
