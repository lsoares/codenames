...
export const things: CardProvider = { id: 'things', label: 'Things', group: 'photos', icon: '🧩', description: 'Concrete, easily-named everyday objects', credit: { label: 'Pexels', url: 'https://www.pexels.com' }, hidden: true, fetch }
