...
export const geeks: CardProvider = { id: 'geeks', label: 'Words 🤓', group: 'words', icon: '💻', description: 'Programming and tech words', credit: { label: 'Stack Overflow', url: 'https://stackoverflow.com' }, fetch }
