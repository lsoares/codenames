...
export const games: CardProvider = { id: 'games', label: 'Games', group: 'culture', difficulty: 'brutal', icon: '🎮', description: 'Artwork from acclaimed video games', credit: { label: 'RAWG', url: 'https://rawg.io' }, fetch }
